...
export const SpTab = dynamic<
  Tab | { children?: ReactNode } | { spTabContentchange: Function }
...
export const SpTabs = dynamic<
  Tabs | { children?: ReactNode } | { change: Function }
>(() => import('./Tabs').then((m) => m.SpTabs as any), { ssr });
