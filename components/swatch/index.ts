...
export const SpSwatch = dynamic<Swatch | { children?: ReactNode } | { change: Function }>(
  () => import('./Swatch').then((m) => m.SpSwatch as any),
  { ssr }
);
export const SpSwatchGroup = dynamic<SwatchGroup | { children?: ReactNode } | { change: Function }>(
